...
#include "UrlsNeighborTreeWidget.h"
...
void MCUrlsNeighborTreeWidget::cleanAll_() {

}

MCUrlsNeighborTreeWidget::MCUrlsNeighborTreeWidget(QWidget* parent)
  : MyQTreeWidget(parent)
{}

MCUrlsNeighborTreeWidget::~MCUrlsNeighborTreeWidget() {
  cleanAll_();
}

void MCUrlsNeighborTreeWidget::setup() {
  ...
  QObject::connect(MCApp->urlsNeighbor(), SIGNAL(urlAdded(MCUrlInfo)), this, SLOT(slotAddUrl_(MCUrlInfo)), Qt::QueuedConnection);
  QObject::connect(MCApp->urlsNeighbor(), SIGNAL(urlRemoved(MCUrlInfo)), this, SLOT(slotRemoveUrl_(MCUrlInfo)), Qt::QueuedConnection);
}

void MCUrlsNeighborTreeWidget::slotAddUrl_(MCUrlInfo urlInfo) {
  ...
  // Set backtracker
  urlInfo.setData("ItemNeighbor", qVariantFromValue<QTreeWidgetItem*>(item));
...
void MCUrlsNeighborTreeWidget::slotRemoveUrl_(MCUrlInfo urlInfo) {
  Assert(urlInfo.isValid() == true);

  QTreeWidgetItem* item = qVariantValue<QTreeWidgetItem*>(urlInfo.data("ItemNeighbor"));
  AssertCheckPtr(item);
