...
#define MCException(m, r)   _MCException(m, r, this, __func__, __FILE__, __LINE__)

class _MCException : public std::exception
{
public:
    _MCException(const QString& message, const QString& remainder = QString(), const QObject* object = NULL, const char* func = __FILE__, const char* file = __FILE__, int line = __LINE__);
    ...
    const QString& className() const {return m_sClassName;}
