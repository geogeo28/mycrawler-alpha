...
#define _MYCRAWLER_SERVER_VERSION_MINOR_         2
#define _MYCRAWLER_SERVER_VERSION_REVISION_      1
...
#define _MYCRAWLER_CLIENT_VERSION_MINOR_         2
#define _MYCRAWLER_CLIENT_VERSION_REVISION_      1
